...
/** Client interactivity for the place page. The route file is a server
 *  component (for metadata + JSON-LD); this child handles city-context
 *  sync, the back button, and the live activity fetch. */
export function PlaceFullPageClient({ city, place }: Props) {
